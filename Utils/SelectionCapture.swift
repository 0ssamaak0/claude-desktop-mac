...
enum SelectionCapture {
    ...
    static func captureSelectedText(completion: @escaping (String?) -> Void) {
        ...
        // Poll for pasteboard change on a background queue, then hop back to main
    ...
    /// Returns true if the process is trusted for Accessibility. Prompts the user on first call.
    @discardableResult
